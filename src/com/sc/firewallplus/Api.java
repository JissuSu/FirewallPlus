...
public final class Api {
	...
	// Messages
	public static final String STATUS_CHANGED_MSG 	= "com.sc.firewallplus.intent.action.STATUS_CHANGED";
	public static final String TOGGLE_REQUEST_MSG	= "com.sc.firewallplus.intent.action.TOGGLE_REQUEST";
	public static final String CUSTOM_SCRIPT_MSG	= "com.sc.firewallplus.intent.action.CUSTOM_SCRIPT";
	// Message extras (parameters)
	public static final String STATUS_EXTRA			= "com.sc.firewallplus.intent.extra.STATUS";
	public static final String SCRIPT_EXTRA			= "com.sc.firewallplus.intent.extra.SCRIPT";
	public static final String SCRIPT2_EXTRA		= "com.sc.firewallplus.intent.extra.SCRIPT2";
	...
	private static String scriptHeader(Context ctx) {
		...
		return "" +
			...
			"	if ! $ECHO 1 | $GREP -q 1 >/dev/null 2>/dev/null ; then\n" +
			"		$ECHO The grep command is required. Firewall Plus will not work.\n" +
			"		exit 1\n" +
			"	fi\n" +
			"fi\n" +
	...
	public static boolean hasRootAccess(final Context ctx, boolean showErrors) {
		...
		if (showErrors) {
			alert(ctx, "Could not acquire root access.\n" +
				...
				"If this device is rooted, please make sure you have given Firewall Plus permission to execute the \"su\" command.\n"
		}
		return false;
	}
    /**
